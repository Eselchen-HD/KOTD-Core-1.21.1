...
import de.eselgamerhd.kotd.common.blocks.entity.MagicalSkullBlockEntity;
...
public class ModEntities {
    ...
    public static final Supplier<BlockEntityType<FlowerPotPackEntity>> FLOWER_POT_PACK_BE = BLOCK_ENTITIES.register("flower_pot_pack_be",
            () -> BlockEntityType.Builder.of(FlowerPotPackEntity::new, ModBlocks.FLOWER_POT_PACK.get()).build(null));
    @SuppressWarnings("DataFlowIssue")
    ...
    public static final Supplier<EntityType<KnightOfTheDark>> KNIGHT_OF_THE_DARK = ENTITY_TYPES.register("knight_of_the_dark",
            () -> EntityType.Builder.of(KnightOfTheDark::new, MobCategory.MONSTER)
                    .sized(0.6F, 1.95F)
                    .clientTrackingRange(8)
                    .updateInterval(3)
                    .build("knight_of_the_dark"));
