...
import de.eselgamerhd.kotd.common.items.renderer.DBHModel;
...
public class DormantBlackHole extends Item implements GeoItem {
    ...
    public static class DBHRenderer extends GeoItemRenderer<DormantBlackHole> { public DBHRenderer() {super(new DBHModel());}}
