...
public class KotdBlockLootTableProvider extends BlockLootSubProvider {
    protected KotdBlockLootTableProvider(HolderLookup.Provider registries) {
    ...
    protected @NotNull Iterable<Block> getKnownBlocks() {
        return KotdBlocks.BLOCKS.getEntries().stream().map(Holder::value)::iterator;
    }
}
